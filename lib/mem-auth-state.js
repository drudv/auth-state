...
const BaseAuthState = require('./base-security-cache');
  ...
  sanitizeOptions(options) {
    ...
    return {
      ...
      initialState: baseSanitized.initialState
        ? validateMemCacheState(baseSanitized.initialState)
        : null,
    };
  }

  init() {
    this._state = this.getOptions.initialState || {
      users: {},
      records: {},
    };
